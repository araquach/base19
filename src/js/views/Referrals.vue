  ...
  <section class="section offers-info hero is-fullheight is-dark">
    <div class="section columns">
      <div class="column is-9-desktop">
        ...
        <p class="is-size-5">Log in to your online user account via <strong>the button below</strong> to locate your
          personalised
          referral link.</p>
        ...
        <p class="is-size-5">If you don't already have an <strong>online account</strong> with us you will need to
