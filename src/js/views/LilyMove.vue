<template>
  <section class="section hour-changes hero is-fullheight is-dark">
    <h1 class="title">Exciting News: Lily is Moving to Jakata Salon!</h1>
    <div class="columns is-reversed-mobile">
      <div class="column is-8">
        ...
        <p class="is-size-5"><em>If you already have an appointment booked with Lily, it will automatically be transferred over to Jakata.</em></p>
        <p class="is-size-3">Thank You for Your Continued Support!</p>
        <p>We’re incredibly grateful for your support and excited for Lily as she begins this next stage of her career. <strong>We can’t wait to welcome you to Jakata soon!</strong></p>
      ...
      <div class="column is-4">
        <img alt="Lily" src="/dist/img/team/profiles/lily/lily_1.jpg">
      </div>
    </div>
  </section>
</template>
