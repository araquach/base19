<template>
  <div id="price-increase">
    <div class="columns">
      <div class="column is-8">
        <section class="section is-size-5 has-text-white">
          <h1 class="title is-2 has-text-white">Just to let you know...</h1>
          ...
          <p><em>Please remember, we offer a range of stylists to suit different budgets, so there are options for
            everyone!</em></p>
          <p class="has-text-success">Your continued support means the world to us and keeps our salon running – thank you, sincerely. If you have any questions or concerns, don’t hesitate to get in touch.</p>
        </section>
      </div>
    </div>
  </div>
