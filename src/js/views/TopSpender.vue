  ...
  <section class="section top-spender hero is-fullheight is-dark">
    <div class="columns">
      <div class="column is-7-desktop">
        ...
        <p>We've had a crazy few years and we're really thank you for your patience and adaptability through the tough times.</p>
        <p class="has-text-warning is-size-4">Base Hairdressing wouldn't be here without you, and for that we'd like to give you a little thank you gift....</p>
        <p class="has-text-warning">This Schwarzkopf Gift Set - choose from Colour Freeze or Repair Rescue</p>
        <figure class="image">
          <img src="/dist/img/top_spender/gift_pack.jpg" alt="Schwarzkopf Gift Pack">
        </figure>
