<template>
    <section class="section corona-info hero is-fullheight is-dark">
        <div class="columns is-vcentered">
          <div id="corona-copy" class="column is-7-desktop">
            ...
            <p class="is-size-5">We continue to have COVID measures in place for your safety and the safety of our team.</p>
            <p class="has-text-danger">Please ensure you read the following guidelines before you come in for your appointment</p>
            <p><strong>Update: As of Saturday 8th August a facemask is required to be worn throughout your visit unless there is a legitimate reason for you not to wear one.</strong></p>
            ...
            <p>Please arrive to the salon at the time of your appointment.</p>
            ...
            <p>We won’t be serving any drinks or offering magazines for a while. This is a way for us to minimise any extra contact. We again realise this is all part of the experience of being in the salon and are hoping that this will only be a very short term measure as we see how things progress over the coming weeks.
              ...
              <br>It's also perfectly fine for you to bring your own book/magazines. We now have Digi Mags available for you to read all the latest titles on your mobile device - ask your stylist for info</p>
            <h3 class="title is-4">Hand Sanitiser</h3>
            <p>We will provide hand sanitiser.
              We will have this on the front desk and on each styling station - please sanitize your hands on arrival.</p>
