<template>
    <div>
        <!--Pre Click-->
        <section id="about" v-if="!showInfo" class="about hero is-fullheight is-dark">
        ...
        <transition name="fade">
            <section id="about" v-if="showInfo"  class="section about-info hero is-fullheight is-dark">
