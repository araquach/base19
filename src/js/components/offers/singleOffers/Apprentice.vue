    ...
    <div v-if="!hideOffers">
      <div class="section columns">
        <div class="column is-9-desktop">
          ...
          <p class="is-size-5">Jamie and Sarah are both progressing fast and are now looking to build their client bases.</p>
          <p class="is-size-5">If you're looking for an amazing style at a fraction of the cost, book in with one of these talented apprentices</p>
          <br>
          <figure class="image">
