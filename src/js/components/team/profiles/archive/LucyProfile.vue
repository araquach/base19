  ...
  <div id="profile" class="section has-text-white">
    <div class="section columns">
      <div class="column is-7">
        ...
        <p>I originally worked at <strong>Jakata</strong>, watching and learning from the best, two years later <strong>Base Hairdressing</strong> opened and I transitioned to complete my training there as it is more intense training, closely focusing on what I need to get perfect to have my own running column on the salon floor.</p>
        ...
        <div class="tile is-ancestor is-flex">
          <div class="tile is-parent is-vertical">
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/hp1.jpg">
              </figure>
            </div>
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/hp2.jpg">
              </figure>
            </div>
          </div>
          <div class="tile is-parent is-vertical">
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/hp3.jpg">
              </figure>
            </div>
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/hp4.jpg">
              </figure>
            </div>
          </div>
          <div class="tile is-parent is-vertical">
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/hp5.jpg">
              </figure>
            </div>
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/hp6.jpg">
              </figure>
            </div>
          </div>
        </div>
      ...
      <div class="column">
        <div class="tile is-ancestor is-flex">
          <div class="tile is-parent is-vertical">
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/p3.jpg">
              </figure>
            </div>
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/hp8.jpg">
              </figure>
            </div>
          </div>
          <div class="tile is-parent is-vertical">
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/hp10.jpg">
              </figure>
            </div>
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/p4.jpg">
              </figure>
            </div>
          </div>
          <div class="tile is-parent is-vertical">
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/hp12.jpg">
              </figure>
            </div>
            <div class="tile is-child">
              <figure class="image">
                <img src="/dist/img/team/profiles/lucy/hp11.jpg">
              </figure>
            </div>
          </div>
        </div>
