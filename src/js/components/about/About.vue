...
<style lang="scss">
    .about {
        background: url("/dist/img/bgrounds/b1.jpg") center top no-repeat;
        background-size: cover;
    }

    .about-info {
        background: linear-gradient(rgba(0,0,0,.85), rgba(0,0,0,.85)), url("/dist/img/bgrounds/b1.jpg") center top no-repeat;
        background-size: cover;
    }
</style>