<template>
  <div>
    <h1 class="title is-4">Cutting & Styling for new clients</h1>
    <p class="is-size-4">We have a few different options in the cutting/styling section, please select the most appropriate.</p>
    ...
    <a href="https://phorest.com/book/salons/basehairacademy" id="book-now-new-cut" class="button is-primary"><strong>Book Now</strong></a>
  </div>
</template>